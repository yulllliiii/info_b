                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form name="frm" id="frm" method="post" onSubmit="return frm_check();">
                                      ...
                                      <!--   <a href="javascript:kakaoLogin();"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWJHdGKLMACWbSytUU1gcOi-RIpG392CWyjDUK69FRP3xahHcH6kwSxPBDZr7MHRgIpA&usqp=CAU" alt="카카오계정으로 로그인" style="width:-webkit-fill-available; margin:auto; display:block";/></a> -->
                                        </form>
